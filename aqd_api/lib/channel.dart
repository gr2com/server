...
class AqdApiChannel extends ApplicationChannel {
  ...
  Future prepare() async {
    ...
    final config = AqdApiConfiguration(options.configurationFilePath);
...
class AqdApiConfiguration extends Configuration {
  AqdApiConfiguration(String fileName) : super.fromFile(File(fileName));
